...
urlpatterns = [
    ...
    path('loveletter/playing/guard1', views.guard1, name='guard1'),
    path('loveletter/playing/guard2', views.guard2, name='guard2'),
    ...
    path('loveletter/playing/guard_card', views.guard_card, name='guard_card'),
